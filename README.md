  ...
  I know there are many ways to group and structure files, but this is the way that has worked best for me. Having this structure allows each folder to house a single intention and functionality within the app (e.g. `styles` - holds all styling for the entirety of the app vs. mixing and matching component / test and style files).
   ...
   Making this project Accessible was extremely important. I decide to use a few tools that would help me get there: 
     1. [Jest Axe](https://www.npmjs.com/package/jest-axe)
         - This is jestt testing package that will run test on your components to check for any acceesesibility violations. As noted on the npm site - it does not mean your app is accessible, it's just a tool to help get you there. 
         - *To see this in action* 
         - run: `yarn test`
     3. Voice Over Screen Reader (imbedded in all Macs) - [to get started read this awesome medium article](https://medium.com/@lsnrae/how-to-use-the-voiceover-screen-reader-70699e2e0f8a#:~:text=Basic%20VoiceOver%20Commands%20(Safari),rotor%20%E2%80%94%20Ctrl%2BOpt%2BU)
     4. IBM Accessibility Checker - [Chrome extension](https://chrome.google.com/webstore/detail/ibm-equal-access-accessib/lkcagbfjnkomcinoddgooolagloogehp)
